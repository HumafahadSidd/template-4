  ...
  return (
    <section className="bg-indigo-50 py-16">
      <div className="container mx-auto flex flex-col md:flex-row items-center px-5">
        ...
        {/* Content Section */}
        <div className="md:w-1/2 mt-10 md:mt-0 md:pl-6 text-center md:text-left">
          <h2 className="text-indigo-900 font-bold text-3xl mb-5">
            Unique Features Of Latest & Trending Products
          </h2>
          ...
          <div className="mt-8">
            <button className="bg-pink-500 text-white px-6 py-3 rounded-md font-semibold hover:bg-pink-600 transition-all duration-200">
              Add To Cart
            </button>
            <p className="mt-4 text-indigo-900 flex-col flex font-medium">
              B&B Italian Sofa <span className="text-gray-600">$32.00</span>
