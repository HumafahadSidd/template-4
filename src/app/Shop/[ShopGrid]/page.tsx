    ...
    <div>
      <div className="container">
        <div className="grid">
            ...
            <div className='box border shadow-md ml-8 flex gap-4 justify-center'>
            <div className=''>
<h4 className='text-indigo-600 text-2xl underline '>Product Brand</h4>
...
<div className="productdiscription flex">
<div>
    <Image src={"/p4/Rectangle 32.png"} alt={""} height={250} width={300} />
</div>
<   div>
    <p></p>
    </div>
